...
export default {
      ...
      tabs: [
        {
          ...
          content: {
            ...
            content: [
              "Введение",
              "Знакомство с платформой Платона",
              "Знакомство с модулями",
              "Настройка платформы PLATON",
              "Создание первой программы на Платоне",
            ],
          },
        },
        {
  ...
  methods: {
    toggleTab(id) {
      if (this.currentTab == id) this.currentTab = "0";
      else this.currentTab = id;
    },
  },
};
</script>
    ...
    <div class="syllabus_content">
      <ul class="syllabus-tabs">
        <li
          ...
          :class="{ 'syllabus-tab': true, opened: tab.id == this.currentTab }"
        >
